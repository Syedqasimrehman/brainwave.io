        ...
        <div className="relative">
          ...
          >
            <div
             ...
             pointer-event-none md:w3/5 xl:w-auto"
            >
              <img
            ...
            <div className="relative max-w-[17rem] z-1 ml-auto">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  <li
                    key={index}
                    className="border-t border-n-6 py-4 flex items-start"
                  >
            ...
            <Generating
              className="z-1 absolute left-4 right-4 
              bottom-4 border border-n-1/10 lg:left-1/2
          ...
          >
            ...
            <div
              className="p-4 bg-n-7 lg:min-h-[46rem] 
