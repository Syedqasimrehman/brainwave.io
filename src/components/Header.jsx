...
import {desablePageScroll , enablePageScroll} from 'scroll-lock';
          ...
          >
            {navigation.map((item) => (
              <a
                ...
                href={item.url}
                onClick={handleClick}
                className={` block font-code relative text-2xl uppercase
